...
public class FabricBlocks extends Feature {
    ...
    public void initialize() {
        ...
        Registry.register(Registry.BLOCK, new ResourceLocation(MOD_ID, "charcoal_block"), CommonObjects.CHARCOAL_BLOCK);
        Registry.register(Registry.BLOCK, new ResourceLocation(MOD_ID, "sugar_block"), CommonObjects.SUGAR_BLOCK);
        Registry.register(Registry.BLOCK, new ResourceLocation(MOD_ID, "flint_block"), CommonObjects.FLINT_BLOCK);
    }
}