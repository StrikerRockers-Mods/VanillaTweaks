    ...
    public void initialize() {
        ...
        ServerTickEvents.START_WORLD_TICK.register(serverWorld -> {
            if (VanillaTweaksFabric.config.enchanting.enableVeteran && serverWorld != null && !serverWorld.isClientSide) {
                serverWorld.getEntities(EntityType.EXPERIENCE_ORB, EntitySelector.ENTITY_STILL_ALIVE).forEach(experienceOrb -> EnchantmentImpl.moveXP(experienceOrb, VETERAN));
            }
        });
