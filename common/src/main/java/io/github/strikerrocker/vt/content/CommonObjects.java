...
public class CommonObjects {
    ...
    public static final Block CHARCOAL_BLOCK = new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLACK).requiresCorrectToolForDrops().strength(5.0f, 6.0f));
    ...
    public static final Block FLINT_BLOCK = new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BROWN).requiresCorrectToolForDrops().strength(3.0f, 6.0f));
